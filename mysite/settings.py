...
SECRET_KEY = 'django-insecure-2s0xbos8*!0@n^5_p9_4%wvc=ni-@sd!&7ejgj%r&e+u!@bc-*'
...
JAZZMIN_SETTINGS = {
    "site_title": "Endroid Admin Panel",
    "site_header": "Endroid Admin Panel",
    "site_brand": "Endroid",
    "login_logo": None,
    "login_logo_dark": None,
    "site_logo_classes": "img-circle",
    "site_icon": None,
    "welcome_sign": "Welcome to the Endroid",
    "copyright": "Endroid",
    "order_with_respect_to": ["main.PageVisit"],
}
